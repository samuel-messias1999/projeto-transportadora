...
def edit_department(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Departamento editado com sucesso.')
...
def delete_role(id):
    ...
    db.session.commit()
    flash('Cargo deletado com sucesso.')

    # redirect to the roles page
    return redirect(url_for('admin.list_roles'))

    return render_template(title="Deletar Cargo")
...
def list_employees():
    ...
    return render_template('admin/employees/employees.html',
                           employees=employees, title='Empregados')
...
def assign_employee(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Departamento e cargo atribuidos com sucesso.')
